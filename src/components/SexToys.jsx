...
import vibrator from "../assets/images/sextoys-vibrator.png";
import buttplug from "../assets/images/sextoys-buttplug.png";
import cockring from "../assets/images/sextoys-cockring.png";
import whip from "../assets/images/sextoys-whip.png";
import lube from "../assets/images/sextoys-lube.png";
            ...
            <div key={sexToy.name} className="col py-3 align-item-stretch">
                <div className="card bg-light-gray border-0 rounded-lg">
                    <div className='d-flex justify-content-center'>
                        <img src={sexToy.image} className="card-img-top rounded-top img-fluid" />
                    </div>
